...
public class VotingLocation extends Location
{
	...
	@RelatedTo(type = DatabaseDomainConstants.HAS_VOTING_LOCATION_LABEL, direction = Direction.INCOMING)
	private Owner owner;
	...
	public static VotingLocation fromVotingLocationDetails(VotingLocationDetails locationDetails)
	{
        ...
        if (LOG.isTraceEnabled()) LOG.trace("votingLocationDetails "+locationDetails);
    ...
    public VotingLocationDetails toVotingLocationDetails()
    {
        ...
        if (LOG.isTraceEnabled()) LOG.trace("votingLocationDetails; "+ votingLocationDetails);
