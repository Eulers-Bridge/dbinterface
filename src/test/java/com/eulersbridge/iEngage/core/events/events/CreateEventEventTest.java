...
public class CreateEventEventTest {
    ...
    private CreateEventEvent createEventEvent;
    ...
    public void testConstructor(){
        createEventEvent = new CreateEventEvent(eventDetails);
        assertNotNull("constructor returns null",createEventEvent);
    }
}