...
public class ElectionCreatedEventTest {
    ...
    public void setUp() throws Exception {
        ...
        electionCreatedEvent = new ElectionCreatedEvent(electionId, electionDetails);
    }
    ...
    public void testElectionCreatedEvent() throws Exception {
        ...
        ElectionCreatedEvent electionCreatedEvent1 = new ElectionCreatedEvent(electionId);
        assertNotNull("electionCreatedEvent is null", electionCreatedEvent1);
    }

    @Test
    public void testGetElectionId() throws Exception {
        assertEquals("electionId does not match", electionId, electionCreatedEvent.getElectionId());
    }

    @Test
    public void testSetKey() throws Exception {
        electionCreatedEvent.setKey(new Long(10));
        assertEquals("id does not match", new Long(10), electionCreatedEvent.getElectionId());
    }
    ...
    public void testSetElectionDetails() throws Exception {
        ...
        assertEquals("electionDetail does not match", electionDetails1, electionCreatedEvent.getElectionDetails());
    }
