...
public class EventUpdatedEventTest {
    ...
    private EventUpdatedEvent eventUpdatedEvent;
    ...
    public void testConstructor() throws Exception{
        eventUpdatedEvent = new EventUpdatedEvent(eventId, eventDetails);
        assertNotNull("eventUpdatedEvent is null", eventUpdatedEvent);
        eventUpdatedEvent = new EventUpdatedEvent(eventId);
        assertNotNull("eventUpdatedEvent is null", eventUpdatedEvent);
    }
}