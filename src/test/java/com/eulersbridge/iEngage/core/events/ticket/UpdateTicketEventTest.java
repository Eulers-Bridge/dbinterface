...
public class UpdateTicketEventTest {
    ...
    UpdateTicketEvent updateTicketEvent;
    ...
    public void testConstructor() throws Exception{
        updateTicketEvent = new UpdateTicketEvent(ticketId, ticketDetails);
        assertNotNull("constructor returns null", updateTicketEvent);
    }
}