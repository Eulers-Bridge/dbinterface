...
//    service = new CommentEventHandler(userRepository, commentRepository, nodeRepository);
//  }
//
//  @After
...
//    when(nodeRepository.findOne(any(Long.class), anyInt())).thenReturn(testObject);
...
//    when(nodeRepository.findOne(any(Long.class))).thenReturn(testObject);
//    when(commentRepository.save(any(Comment.class))).thenReturn(testComment);
//
//    CommentDetails commentDetails = testComment.toCommentDetails();
//    CreatedEvent commentCreatedEvent = service.createComment(new CreateCommentEvent(commentDetails));
