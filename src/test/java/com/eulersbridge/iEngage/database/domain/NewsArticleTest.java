...
public class NewsArticleTest {
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.NewsArticle(java.lang.String, java.lang.String, java.lang.Iterable, java.util.Calendar, com.eulersbridge.iEngage.database.domain.User)}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.NewsArticle()}.
   */
  @Test
  public void testGetLikes() {
    assertEquals("No likers at this point.", 0, news.getNumOfLikes().intValue());
  }
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.NewsArticle(com.eulersbridge.iEngage.database.domain.User)}.
   */
  @Test
...
//TODO		assertEquals("Pictures don't match.",news2.getPicture(),dets.getPicture());
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.NewsArticle(com.eulersbridge.iEngage.database.domain.NewsArticle)}.
   */
  @Test
