...
public class DatabaseDataFixture {
  ...
  public static Country populateCountry(Long nodeId, String countryName, List<Institution> institutions) {
  ...
  public static NewsArticle populateNewsArticle(String title, String content, List<Photo> picture, User creator, Calendar date, Long id, NewsFeed studentYear) {
    NewsArticle article = new NewsArticle(title, content, date, creator);
    Long nodeId = id;
    article.setNodeId(nodeId);
    article.setNewsFeed(studentYear);
    article.setPhotos(Node.castList(picture));
    return article;
  }
  ...
  public static Event populateEvent(Long id, String name, String description, String location, String organizer, String organizerEmail, List<Photo> photos, Long created, Long modified, Long starts, Long ends, NewsFeed newsFeed) {
    ...
    event.setPhotos(Node.castList(photos));
    return event;
  }
  ...
  public static List<PollResultTemplate> populatePollResultDetails1() {
    ...
    return populatePollResultDetails(prts);
  }

  public static List<PollResultTemplate> populatePollResultDetails2() {
  ...
  public static List<PollResultTemplate> populatePollResultDetails(List<PollResultTemplate> results) {
    return results;
  }
  ...
  public static Ticket populateTicket(Long ticketId, String name, String logo, String information, List<Candidate> candidates, Election election, String characterCode, Long numberOfSupporters) {
    Ticket ticket = new Ticket(ticketId, name, logo, information, Node.castList(candidates), election, characterCode);
    return ticket;
  }
