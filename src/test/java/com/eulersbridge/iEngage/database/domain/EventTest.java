...
public class EventTest {
  ...
  public final void testFromEventDetails() {
    ...
    Institution institution = new Institution(dets.getInstitutionId());
    NewsFeed newsFeed = new NewsFeed();
    newsFeed.setInstitution(institution);
    evt2.setNewsFeed(newsFeed);
    ...
    System.out.println(dets.getInstitutionId());
    System.out.println(evt2.getNewsFeed$());
...
//TODO		assertEquals(dets2.getPhotos(),event.getPhotos());
  ...
  /**
   * Test method for {@link Event#getPhotos$()}.
   */
//TODO
  /*
	@Test
