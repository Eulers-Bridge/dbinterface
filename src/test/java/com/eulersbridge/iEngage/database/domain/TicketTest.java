...
//		assertTrue(checkCandidateIdsEqual(dets.getCandidateIds(),Ticket.toCandidateIds(evt2.getCandidates())));
	...
	/**
	 * Test method for {@link com.eulersbridge.iEngage.database.domain.Ticket#Ticket(java.lang.Long, java.lang.String, java.lang.String, java.lang.String, java.lang.Iterable, com.eulersbridge.iEngage.database.domain.Election)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link com.eulersbridge.iEngage.database.domain.Ticket#setCandidate(java.lang.Iterable)}.
	 */
	@Test
	public final void testSetCandidate()
	{
		Iterable<Candidate> candidates=DatabaseDataFixture.populateTicket2().getCandidates();
		assertNotEquals(candidates,ticket.getCandidates());
		ticket.setCandidate(candidates);
		assertEquals(candidates, ticket.getCandidates());
	}
	...
	/**
	 * Test method for {@link com.eulersbridge.iEngage.database.domain.Ticket#setElection(com.eulersbridge.iEngage.database.domain.Election)}.
	 */
	@Test
	...
	public final void testHashCode()
	{
		...
		ticketTest.setCandidate(null);;
		checkHashCode(ticket,ticketTest);
		ticketTest.setCandidate(ticket.getCandidates());
	}
	...
	public final void testEquals()
	{
		...
		ticketTest.setCandidate(DatabaseDataFixture.populateTicket2().getCandidates());
		assertNotEquals(ticket, ticketTest);
		ticketTest.setCandidate(null);
		checkNotEquals(ticket, ticketTest);
		ticketTest.setCandidate(ticket.getCandidates());
