...
public class UserTest {
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.User#(com.eulersbridge.iEngage.database.domain.Institution)}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.User#getAccountVerified()}.
   */
  @Test
  public final void testIsAccountVerified() {
    assertNotEquals("isAccountVerified() returns incorrect  value", user.getAccountVerified(), true);
    assertEquals("isAccountVerified() returns expected value", user.getAccountVerified(), false);
  }
  ...
  public final void testSetAccountVerified() {
    ...
    assertNotEquals("getGivenName() returns incorrect  value", user.getAccountVerified(), userDetails.isAccountVerified());
    user.setAccountVerified(false);
    assertEquals("getEmail() returns expected value", user.getAccountVerified(), userDetails.isAccountVerified());
  }
  ...
  /**
   * Test method for {@link com.eulersbridge.iEngage.database.domain.User#(com.eulersbridge.iEngage.database.domain.User)}.
   */
  @Test
