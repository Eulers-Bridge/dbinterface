...
public class ViewNewsIntegrationTest {
	...
	public final void testAlterNewsArticle() throws Exception 
	{
		...
		String content="{\"articleId\":1,\"institutionId\":1,\"title\":\"Test Article2\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":"+dets.getDate()+",\"creatorEmail\":\"gnewitt@hotmail.com\"}";
		String returnedContent="{\"articleId\":1,\"institutionId\":1,\"title\":\"Test Article2\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":"+dets.getDate()+",\"creatorEmail\":\"gnewitt@hotmail.com\",\"links\":[{\"rel\":\"self\",\"href\":\"http://localhost/api/newsArticle/1\"},{\"rel\":\"Previous\",\"href\":\"http://localhost/api/newsArticle/1/previous\"},{\"rel\":\"Next\",\"href\":\"http://localhost/api/newsArticle/1/next\"},{\"rel\":\"Liked By\",\"href\":\"http://localhost/api/newsArticle/1/likedBy/USERID\"},{\"rel\":\"UnLiked By\",\"href\":\"http://localhost/api/newsArticle/1/unlikedBy/USERID\"},{\"rel\":\"Likes\",\"href\":\"http://localhost/api/newsArticle/1/likes\"},{\"rel\":\"Read all\",\"href\":\"http://localhost/api/newsArticles\"}]}";
	...
	public void testAlterNewsArticleNullEventReturned() throws Exception
	{
		if (LOG.isDebugEnabled()) LOG.debug("performingAlterNewsArticle()");
		Long id=1L;
		String content="{\"articleId\":1,\"institutionId\":1,\"title\":\"Test Article\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":1234567,\"creatorEmail\":\"gnewitt@hotmail.com\"}";
...
//TODO This should not be returning boolean.
	...
	public final void testCreateNewsArticle() throws Exception 
	{
		...
		String content="{\"institutionId\":1,\"title\":\"Test Article\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":"+dets.getDate()+",\"creatorEmail\":\"gnewitt@hotmail.com\"}";
		String returnedContent="{\"articleId\":1,\"institutionId\":1,\"title\":\"Test Article\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":"+dets.getDate()+",\"creatorEmail\":\"gnewitt@hotmail.com\",\"links\":[{\"rel\":\"self\",\"href\":\"http://localhost/api/newsArticle/1\"},{\"rel\":\"Previous\",\"href\":\"http://localhost/api/newsArticle/1/previous\"},{\"rel\":\"Next\",\"href\":\"http://localhost/api/newsArticle/1/next\"},{\"rel\":\"Liked By\",\"href\":\"http://localhost/api/newsArticle/1/likedBy/USERID\"},{\"rel\":\"UnLiked By\",\"href\":\"http://localhost/api/newsArticle/1/unlikedBy/USERID\"},{\"rel\":\"Likes\",\"href\":\"http://localhost/api/newsArticle/1/likes\"},{\"rel\":\"Read all\",\"href\":\"http://localhost/api/newsArticles\"}]}";
...
//		.andExpect(jsonPath("$.likers",is(dets.getLikers())))
	...
	public final void testCreateNewsArticleInvalidContent() throws Exception 
	{
		...
		String content="{\"institutionId1\":1,\"title\":\"Test Article\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":12345678,\"creatorEmail\":\"gnewitt@hotmail.com\"}";
		when (newsService.createNewsArticle(any(CreateNewsArticleEvent.class))).thenReturn(testData);
		this.mockMvc.perform(post(urlPrefix+"/").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON).content(content))
		.andDo(print())
		.andExpect(status().isBadRequest())	;		
	...
	public final void testCreateNewsArticleInstNotFound() throws Exception 
	{
		...
		String content="{\"institutionId\":56,\"title\":\"Test Article\",\"content\":\"Contents of the Test Article\",\"picture\":null,\"likers\":null,\"date\":"+dets.getDate()+",\"creatorEmail\":\"gnewitt@hotmail.com\"}";
		when (newsService.createNewsArticle(any(CreateNewsArticleEvent.class))).thenReturn(testData);
		this.mockMvc.perform(post(urlPrefix+"/").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON).content(content))
		.andDo(print())
		.andExpect(status().isBadRequest())	;		
	...
	public final void testFindArticles() throws Exception 
	{
		...
		.andDo(print())
		.andExpect(jsonPath("$[0].title",is(artDets.get(0).getTitle())))
		.andExpect(jsonPath("$[0].date",is(artDets.get(0).getDate())))
		.andExpect(jsonPath("$[0].creatorEmail",is(artDets.get(0).getCreatorEmail())))
		.andExpect(jsonPath("$[0].content",is(artDets.get(0).getContent())))
		.andExpect(jsonPath("$[0].articleId",is(artDets.get(0).getNewsArticleId().intValue())))
		.andExpect(jsonPath("$[0].institutionId",is(artDets.get(0).getInstitutionId().intValue())))
		.andExpect(jsonPath("$[1].title",is(artDets.get(1).getTitle())))
		.andExpect(jsonPath("$[1].date",is(artDets.get(1).getDate())))
		.andExpect(jsonPath("$[1].creatorEmail",is(artDets.get(1).getCreatorEmail())))
		.andExpect(jsonPath("$[1].content",is(artDets.get(1).getContent())))
		.andExpect(jsonPath("$[1].articleId",is(artDets.get(1).getNewsArticleId().intValue())))
		.andExpect(jsonPath("$[1].institutionId",is(artDets.get(1).getInstitutionId().intValue())))
//TODO
/*		.andExpect(jsonPath("$.picture",is(dets.getPicture())))
		.andExpect(jsonPath("$.likers",is(dets.getLikers())))
/		.andExpect(jsonPath("$.links[0].rel",is("self")))
